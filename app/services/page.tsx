...
const services = [
  { num: '01', title: 'Web Development', desc: 'Building responsive and modern web applications.', href: "" },
          ...
          {services.map((service, index) => (
            <div key={index} className='flex-1 flex flex-col justify-center gap-6 group'>
              <div className='w-full flex justify-between items-center'>
                ...
                <Link href={service.href} className='w-17.5 h-17.5 rounded-full bg-white group-hover:bg-accent transition-all duration-500 flex justify-center items-center hover:-rotate-45'>
