          ...
          <div className="flex xl:flex-row gap-0 xl:gap-10 order-2 xl:order-1 flex-1">
            ...
            <div className="text-center xl:text-left flex flex-col justify-center">
              ...
              <h1 ref={h1Ref} className="mb-7 overflow-hidden">
                <span
                  className="line-word block text-[52px] xl:text-[78px] leading-[0.9] font-black uppercase tracking-tight opacity-0"
                  style={{ fontFamily: "'Bebas Neue', sans-serif" }}
                >
                  Hello I'm
                </span>
                <span
                  className="line-word block text-[52px] xl:text-[78px] leading-[0.9] font-black uppercase tracking-tight text-accent opacity-0"
                  style={{ fontFamily: "'Bebas Neue', sans-serif" }}
                >
                  Bethuel
                </span>
              ...
              <div
                ref={actionsRef}
                className="flex flex-col xl:flex-row items-center xl:items-start gap-6 opacity-0"
              >
                {/* CV button */}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <Socials
                    ...
                    iconStyles="w-9 h-9 border border-white/10 flex justify-center items-center text-white/40 hover:border-accent hover:text-accent transition-all duration-300 hover:shadow-[0_0_14px_rgba(0,255,153,0.25)]"
                  />
                </div>
              </div>
            </div>
