...
const Contact = () => {
  ...
  useEffect(() => {
    // Set all visible by default — animation is progressive enhancement
    const all = sectionRef.current?.querySelectorAll(
      '.contact-header, .contact-info-card, .contact-form, .form-field'
    )
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.from('.contact-form',      { ...base, y: 32, opacity: 0, duration: 0.65, delay: 0.15 })
              ...
              <div className="flex items-center gap-6 pt-2">
                <button
                  ...
                  className="px-12 py-4 bg-accent text-black uppercase tracking-[2px] font-semibold text-xs
                    transition-all duration-300 hover:shadow-[0_0_24px_rgba(0,255,153,0.35)] hover:scale-[1.03] active:scale-95"
                >
                  Send message
                </button>
